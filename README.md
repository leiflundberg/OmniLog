...
## Setup & Run on Windows 11

### 1. Prerequisites
- **OS**: Windows 11
- **Developer Tools**: [Visual Studio 2022](https://visualstudio.microsoft.com/) (Version 17.10+) or [.NET 10 SDK](https://dotnet.microsoft.com/download).
...
> [!IMPORTANT]
> **Administrator Privileges**: Querying the **Security** log requires running Visual Studio or the application terminal as **Administrator**. Standard logs like **Application** and **System** logs can be read by standard user privileges.
